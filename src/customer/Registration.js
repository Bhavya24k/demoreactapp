...
export default function Registration() 
{
  ...
  const handleSubmit = async (e) => 
  {
    ...
    try 
    {
      const response = await axios.post('http://localhost:2024/insertcustomer', formData);
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <textarea type="text" id="location" value={formData.location} onChange={handleChange} required />
        </div>
        <div>
          <label>Contact</label>
